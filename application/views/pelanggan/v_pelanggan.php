<html lang="en">
	...
	<body>
    <form action="<?php echo site_url('customers/search'); ?>" method="POST">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
              <div class="btn-group mr-2">
                <button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#tambah-pelanggan">Tambah Pelanggan</button>
              </div>
            </div>
          </div>
            ...
            <table class="table table-striped table-sm">
              ...
              <?php $no=1; foreach($record as $r) { ?> 
                <tr>
                  ...
                  <td class="center">
                    <a class="btn btn-mini" href="<?php echo site_url('customers/edit/'.$r->id_pengguna)?>">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M20 14.66V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h5.34"></path><polygon points="18 2 22 6 12 16 8 16 8 12 18 2"></polygon></svg> Edit</a> | 
                    <a class="btn btn-mini" href="<?php echo site_url('customers/hapus/'.$r->id_pengguna)?>">
      ...
      <div class="modal fade" id="tambah-pelanggan" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url().'customers/proses'?>">
