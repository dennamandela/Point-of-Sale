    ...
    <form action="<?php echo site_url('product/cari'); ?>" method="POST">
		...
		<div class="container-fluid">
  		<div class="row">
            ...
            <a href="<?php echo site_url() ?>product/tambah3" class="btn btn-sm btn-info">Tambah</a>
          <hr>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                <?php $id = 1; foreach ($barang as $r){ ?>
                  <tr>
                    <th scope="row"><?php echo $id; ?></th>
                    <td><img src="<?=base_url('assets/img/'.$r->image)?>" max-width='100%' max-height='100%' height='100px'/></td>
                    <td><?php echo $r->nama_barang ?></td>
                    <td><?php echo $r->nama_kategori ?></td>
                    <td>Rp. <?php echo number_format($r->harga) ?></td>
                    <td class="center">
                      <a class="btn btn-mini" href="<?php echo site_url('product/edit/'.$r->barang_id)?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M20 14.66V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h5.34"></path><polygon points="18 2 22 6 12 16 8 16 8 12 18 2"></polygon></svg> Edit</a> | 
                      <a class="btn btn-mini" href="<?php echo site_url('product/hapus/'.$r->barang_id)?>">
